...
- **Read**: Access to media files (PDFs, images, etc.) for analysis. Secrets (`.env`) are blocked.
- **Constraints**: You are a specialized data extraction agent. You do not modify files or execute shell commands.

If you need to access a file or tool outside these bounds, the system will prompt the user for approval.
