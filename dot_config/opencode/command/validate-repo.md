...
1. List all files in `/home/user/.config/opencode/context/`
...
1. **Orphaned Context File**
   - File: `/home/user/.config/opencode/context/legacy/old-patterns.md`
...
1. **Missing Context File**
   ...
   - Expected path: `/home/user/.config/opencode/context/core/advanced-patterns.md`
...
1. Create missing file: `/home/user/.config/opencode/context/core/advanced-patterns.md`
