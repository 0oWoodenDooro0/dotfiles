...
<workflow id="analyze_context_dependencies">
  <stage id="1" name="ScanAgents" required="true">
    ...
    **Search patterns**:
    - `/home/user/.config/opencode/context/` (direct path references)
    - `@/home/user/.config/opencode/context/` (@ symbol references)
  ...
  <stage id="3" name="ValidateContextFiles" required="true">
    ...
    **Check existence**:
    ```bash
    test -f /home/user/.config/opencode/context/core/standards/code-quality.md
    ```
  ...
  <stage id="4" name="Report" required="true">
    ...
    **Uses but not declared**:
    - context:core/standards/code (referenced 3 times)
      - Line 64: "Code tasks → /home/user/.config/opencode/context/core/standards/code-quality.md (MANDATORY)"
      - Line 170: "Read /home/user/.config/opencode/context/core/standards/code-quality.md NOW"
...
```bash
grep -rn "\/home/user/.config/opencode/context/" .opencode/agent/ .opencode/command/
```
...
- `/home/user/.config/opencode/context/core/standards/code-quality.md` → `context:core/standards/code`
- `@/home/user/.config/opencode/context/openagents-repo/quick-start.md` → `context:openagents-repo/quick-start`
...
task(
  ...
  prompt=`
    ...
    2. Search for these patterns:
       - "/home/user/.config/opencode/context/core/" (direct paths)
       - "@/home/user/.config/opencode/context/" (@ references)
    ...
    4. For each context file in /home/user/.config/opencode/context/core/:
...
✓ /home/user/.config/opencode/context/core/context-system.md (1 reference)
  - Line 15: "Load: context:core/context-system"
✓ /home/user/.config/opencode/context/core/context-system/standards/mvi.md (2 references)
...
- **Context guide**: `/home/user/.config/opencode/context/openagents-repo/quality/registry-dependencies.md`
