...
**Core Standards**:
- `/home/user/.config/opencode/context/core/standards/code.md` → Modular, functional code patterns
- `/home/user/.config/opencode/context/core/standards/tests.md` → Testing requirements and TDD
- `/home/user/.config/opencode/context/core/standards/docs.md` → Documentation standards
- (example: `/home/user/.config/opencode/context/core/standards/patterns.md`) → Error handling, security patterns

**Core Workflows**:
- (example: `/home/user/.config/opencode/context/core/workflows/delegation.md`) → Delegation process
- (example: `/home/user/.config/opencode/context/core/workflows/task-breakdown.md`) → Task breakdown methodology
- (example: `/home/user/.config/opencode/context/core/workflows/review.md`) → Code review guidelines
