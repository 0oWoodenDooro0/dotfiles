...
**Core Standards**:
- `/home/user/.config/opencode/context/core/standards/code-quality.md` → Modular, functional code patterns
- `/home/user/.config/opencode/context/core/standards/test-coverage.md` → Testing requirements and TDD
- `/home/user/.config/opencode/context/core/standards/documentation.md` → Documentation standards
- `/home/user/.config/opencode/context/core/standards/security-patterns.md` → Error handling, security patterns

**Core Workflows**:
- `/home/user/.config/opencode/context/core/workflows/task-delegation-basics.md` → Delegation process
- `/home/user/.config/opencode/context/core/workflows/feature-breakdown.md` → Task breakdown methodology
- `/home/user/.config/opencode/context/core/workflows/code-review.md` → Code review guidelines

## Repository-Specific Context (Load These Before Starting)

**Quick Start** (ALWAYS load first):
- `/home/user/.config/opencode/context/openagents-repo/quick-start.md` → Repo orientation and common commands

**Core Concepts** (Load based on task type):
- `/home/user/.config/opencode/context/openagents-repo/core-concepts/agents.md` → How agents work
- `/home/user/.config/opencode/context/openagents-repo/core-concepts/evals.md` → How testing works
- `/home/user/.config/opencode/context/openagents-repo/core-concepts/registry.md` → How registry works
- `/home/user/.config/opencode/context/openagents-repo/core-concepts/categories.md` → How organization works

**Guides** (Load for specific workflows):
- `/home/user/.config/opencode/context/openagents-repo/guides/adding-agent-basics.md` → Step-by-step agent creation
- `/home/user/.config/opencode/context/openagents-repo/guides/testing-agent.md` → Testing workflow
- `/home/user/.config/opencode/context/openagents-repo/guides/updating-registry.md` → Registry workflow
- `/home/user/.config/opencode/context/openagents-repo/guides/debugging.md` → Troubleshooting

**Lookup** (Quick reference):
- `/home/user/.config/opencode/context/openagents-repo/lookup/file-locations.md` → Where everything is
- `/home/user/.config/opencode/context/openagents-repo/lookup/commands.md` → Command reference
...
2. **Copy template**:
   ```bash
   cp /home/user/.config/opencode/context/openagents-repo/templates/context-bundle-template.md \
...
See `/home/user/.config/opencode/context/openagents-repo/examples/context-bundle-example.md` for a complete example.
