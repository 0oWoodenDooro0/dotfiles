...
| **Context files** | `/home/user/.config/opencode/context/` |
...
| **New context** | `/home/user/.config/opencode/context/{category}/{name}.md` |
...
```
/home/user/.config/opencode/context/{category}/{topic}.md
```

**Examples**:
- `/home/user/.config/opencode/context/core/standards/code-quality.md`
- `/home/user/.config/opencode/context/ui/web/react-patterns.md`
- `/home/user/.config/opencode/context/content-creation/principles/copywriting-frameworks.md`
...
```bash
# By category
ls /home/user/.config/opencode/context/{category}/

# All context
find /home/user/.config/opencode/context -name "*.md"
```
