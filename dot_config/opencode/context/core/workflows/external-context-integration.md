...
- Answer is in `/home/user/.config/opencode/context/` (use ContextScout instead)
...
- **External Context Management**: `/home/user/.config/opencode/context/core/workflows/external-context-management.md`
- **Task Delegation**: `/home/user/.config/opencode/context/core/workflows/task-delegation-basics.md`
